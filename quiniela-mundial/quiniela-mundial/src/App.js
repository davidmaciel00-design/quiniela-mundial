                  ...
                  <div key={m.id} style={{background:"rgba(255,255,255,0.04)",borderRadius:10,padding:14,marginBottom:10,border:`1px solid ${hasResult?"rgba(100,200,100,0.2)":"rgba(255,255,255,0.07)"}`}}>
                    <div style={{display:"flex",alignItems:"center",gap:8}}>
                      ...
                      <input type="number" min="0" max="20"
                        value={predScore.home !== undefined && predScore.home !== "" ? predScore.home : ""}
                        onChange={e=>{const v=e.target.value; updateMyPred(prev=>({...prev,knockoutMatches:{...(prev.knockoutMatches||{}),[m.id]:{...(prev.knockoutMatches?.[m.id]||{}),home:v}}}));}}
                        style={{width:44,textAlign:"center",background:"#071828",border:"1px solid #1a4a6a",borderRadius:6,color:"#f0d060",fontSize:16,fontWeight:700,padding:4,WebkitAppearance:"none"}}/>
                      <span style={{color:"#5a7a9a",fontWeight:700}}>-</span>
                      <input type="number" min="0" max="20"
                        value={predScore.away !== undefined && predScore.away !== "" ? predScore.away : ""}
                        onChange={e=>{const v=e.target.value; updateMyPred(prev=>({...prev,knockoutMatches:{...(prev.knockoutMatches||{}),[m.id]:{...(prev.knockoutMatches?.[m.id]||{}),away:v}}}));}}
                        style={{width:44,textAlign:"center",background:"#071828",border:"1px solid #1a4a6a",borderRadius:6,color:"#f0d060",fontSize:16,fontWeight:700,padding:4,WebkitAppearance:"none"}}/>
                      <span style={{flex:1,textAlign:"left",fontSize:13,fontWeight:600}}>{m.away} {flag(m.away)}</span>
                    </div>
