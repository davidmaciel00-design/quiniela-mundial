...
const PLAYERS = ["Sergio","Juan Carlos","Iñigo","Gustavo","David","Julio","Periquín"];
const PLAYER_PINS = ["1111","2222","3333","4444","5555","6666","7777"];
          ...
          return(
            <div>
              <div style={{background:"linear-gradient(135deg,rgba(200,168,0,0.2),rgba(200,168,0,0.05))",border:"1px solid rgba(200,168,0,0.4)",borderRadius:12,padding:"14px 16px",marginBottom:16,textAlign:"center"}}>
                ...
                <div style={{fontSize:11,color:"#7a9a7a",marginTop:2}}>${PRIZE_PER_PLAYER} por jugador · {PLAYERS.length} participantes</div>
              </div>
